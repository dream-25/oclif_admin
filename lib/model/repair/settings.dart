...
Future<String?> repairSettings() async {
  try {
    FirebaseFirestore.instance.collection("settings").doc("main").set({
      "about":
          "We are a LICENSED, BONDED and INSURED Service Provider that was founded in 2004. Over the years we have grown into the successful company that we are today. We have focused our vision on doing what is best for our customers by providing excellence and quality service. We know that by providing our customers with the necessities they need and the customer service they deserve that our company will continue to strive and grow in this industry. We at Oclif at Your Command are also committed to the personal development of our employees. By having educated employees that have their own goals and aspirations, we know we can continue to ensure excellence in our Oclif services and products. Oclif at Your Command is your best choice for your Oclif and home remodeling needs.<br><br>We at Oclif at Your Command take great pride in our work. Every project that we work on is a direct reflection not only on our name, but also the personal levels of quality and dedication we have to customer service. You can guarantee that when you work with our Oclif and home remodeling professionals, your project will be done the right way and to your satisfaction. We stand behind all of our work by offering a one-year warranty on craftsmanship for small projects and three years on large remodel projects.<br><br>The mission of Oclif at Your Command is to enrich the life of each customer by providing unique services to our customers and exceptional craftsmanship, all while maintaining a pleasant work environment. By fulfilling this mission, Oclif at Your Command will realize its vision to be an innovative leader in the home improvement market.",
      "rightSymbol": false,
      "digitsAfterComma": 2,
      "code": "INR",
      "symbol": "₹",
