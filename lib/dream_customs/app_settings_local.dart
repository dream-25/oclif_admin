...
AppSettingsLocal appSettings = AppSettingsLocal.createEmpty();
...
Future<String?> loadSettings(Function() callbackLoad) async {
  FirebaseFirestore.instance
    ...
    if (data != null) {
      appSettings = AppSettingsLocal.fromJson(
          data, appSettings.currentServiceAppLanguage);
      appSettings.setPriceStringDataForUtils();
      callbackLoad();
      if (redrawMainWindowInitialized) redrawMainWindow();
    }
  }).onError((ex) {
  ...
  try {
    var querySnapshot = await FirebaseFirestore.instance
        ...
        .get();
    var data = querySnapshot.data();
    if (data != null) appSettings.setPriceStringDataForUtils();
  } catch (ex) {
...
class AppSettingsLocal {
  ...
  getTimeFormat() {
    if (timeFormat == "12h") return 'hh:mm a';
    return 'HH:mm';
  }

  setPriceStringDataForUtils() =>
      setPriceStringData(rightSymbol, digitsAfterComma, "₹", distanceUnit);
  ...
  AppSettingsLocal({
    ...
    this.cloudKey = "",
    this.copyright = "© 2021 Handyman & Team",
    this.policy = "",
    this.about = "",
    this.terms = "",
    this.googlePlayLink = "",
    ...
    this.paypalClientId = "",
    this.razorpayEnable = false,
    this.razorpayName = "",
    this.razorpayKey = "",
    this.payStackEnable = false,
    this.payStackKey = "",
    this.flutterWaveEnable = false,
    this.flutterWaveEncryptionKey = "",
    this.flutterWavePublicKey = "",
    this.mercadoPagoEnable = false,
    this.mercadoPagoAccessToken = "",
    this.mercadoPagoPublicKey = "",
    this.payMobEnable = false,
    this.payMobApiKey = "",
    this.payMobFrame = "",
    this.payMobIntegrationId = "",
    this.instamojoEnable = false,
    this.instamojoToken = "",
    this.instamojoApiKey = "",
    this.instamojoSandBoxMode = true,
    this.payUEnable = false,
    this.payUApiKey = "",
    this.payUMerchantId = "",
    ...
    this.otpPrefix = "",
    this.otpNumber = 10,
    this.defaultServiceAppLanguage = "en",
    this.defaultProviderAppLanguage = "en",
    this.defaultAdminAppLanguage = "en",
    this.defaultSiteAppLanguage = "en",
    this.currentServiceAppLanguage = "",
    this.currentAdminLanguage = "en",
    required this.statuses,
    this.statusesFound = false,
    this.twilioAccountSID = "",
    this.twilioAuthToken = "",
    this.twilioServiceId = "",
    this.otpTwilioEnable = false,
    this.paypalSandBox = true,
    this.otpNexmoEnable = false,
    this.nexmoFrom = "",
    this.nexmoText = "",
    this.nexmoApiKey = "",
    this.nexmoApiSecret = "",
    this.otpSMSToEnable = false,
    this.smsToFrom = "",
    this.smsToText = "",
    this.smsToApiKey = "",
    //
    this.inMainScreenServices = const [],
    this.customerAppElements = const [],
    this.customerAppElementsDisabled = const [],
    this.adminDarkMode = false,
    //
    this.bookingCount = 0,
    this.bookingCountUnread = 0,
    this.blogCount = 0,
    this.providerCount = 0,
    this.serviceCount = 0,
    this.customersCount = 0,
    this.providerRequestCount = 0,
    this.providerNewRequestCount = 0,
    this.serviceReviews = 0,
    this.offersCount = 0,
    this.langVersion = 0,
    //
    this.providerAreaMapZoom = 0,
    this.providerAreaMapLat = 0,
    this.providerAreaMapLng = 0,
    this.defaultAdminComission = 0,
    //
    this.customerMainColor = const Color(0xff3c7396),
    this.customerLogoLocal = "",
    this.customerLogoServer = "",
    this.customerFontSize = 14,
    this.customerCategoryImageSize = 80,
    this.providerMainColor = const Color(0xff3c7396),
    this.providerLogoLocal = "",
    this.providerLogoServer = "",
    this.websiteMainColor = const Color(0xff3c7396),
    this.websiteLogoLocal = "",
    this.websiteLogoServer = "",
    this.adminPanelMainColor = const Color(0xff3c7396),
    this.adminPanelLogoLocal = "",
    this.adminPanelLogoServer = "",
    ...
    this.subscriptionsPromotionText = "",
  ...
  factory AppSettingsLocal.fromJson(
      Map<String, dynamic> data, String _currentServiceAppLanguage) {
    //
    ...
    return AppSettingsLocal(
      ...
      langVer:
          data["lang_ver"] != null ? toInt(data["lang_ver"].toString()) : 0,
      demo: data["demo"] ?? false,
      rightSymbol: data["right_symbol"] ?? false,
      digitsAfterComma: data["digits_after_comma"] != null
          ? toInt(data["digits_after_comma"].toString())
          : 2,
      code: data["code"] ?? "INR",
      symbol: data["symbol"] ?? "₹",
      ...
      otpNumber:
          data["otpNumber"] != null ? toInt(data["otpNumber"].toString()) : 10,
      ...
      bookingCount: data["booking_count"] != null
          ? toInt(data["booking_count"].toString())
          : 0,
      bookingCountUnread: data["booking_count_unread"] != null
          ? toInt(data["booking_count_unread"].toString())
          : 0,
      providerCount: data["provider_count"] != null
          ? toInt(data["provider_count"].toString())
          : 0,
      blogCount:
          data["blog_count"] != null ? toInt(data["blog_count"].toString()) : 0,
      serviceCount: data["service_count"] != null
          ? toInt(data["service_count"].toString())
          : 0,
      providerRequestCount: data["provider_request_count"] != null
          ? toInt(data["provider_request_count"].toString())
          : 0,
      providerNewRequestCount: data["provider_new_request_count"] != null
          ? toInt(data["provider_new_request_count"].toString())
          : 0,
      customersCount: data["customersCount"] != null
          ? toInt(data["customersCount"].toString())
          : 0,
      serviceReviews: data["service_reviews"] != null
          ? toInt(data["service_reviews"].toString())
          : 0,
      offersCount: data["offer_count"] != null
          ? toInt(data["offer_count"].toString())
          : 0,
      //
      langVersion: data["langVersion"] != null
          ? toInt(data["langVersion"].toString())
          : 0,
      //
      providerAreaMapZoom: data["providerAreaMapZoom"] != null
          ? toDouble(data["providerAreaMapZoom"].toString())
          : 0.0,
      providerAreaMapLat: data["providerAreaMapLat"] != null
          ? toDouble(data["providerAreaMapLat"].toString())
          : 0.0,
      providerAreaMapLng: data["providerAreaMapLng"] != null
          ? toDouble(data["providerAreaMapLng"].toString())
          : 0.0,
      defaultAdminComission: data["def_admin_comission"] != null
          ? toInt(data["def_admin_comission"].toString())
          : 0,
      //
      customerMainColor: (data["customerMainColor"] != null)
          ? toColor(data["customerMainColor"])
          : Color(0xff69c4ff),
      customerLogoLocal: data["customerLogoLocal"] ?? "",
      customerLogoServer: data["customerLogoServer"] ?? "",
      customerFontSize: data["customerFontSize"] != null
          ? toDouble(data["customerFontSize"].toString())
          : 14.0,
      customerCategoryImageSize: data["customerCategoryImageSize"] != null
          ? toDouble(data["customerCategoryImageSize"].toString())
          : 80.0,
      providerMainColor: (data["providerMainColor"] != null)
          ? toColor(data["providerMainColor"])
          : Color(0xff69c4ff),
      providerLogoLocal: data["providerLogoLocal"] ?? "",
      providerLogoServer: data["providerLogoServer"] ?? "",
      websiteMainColor: (data["websiteMainColor"] != null)
          ? toColor(data["websiteMainColor"])
          : Color(0xff69c4ff),
      websiteLogoLocal: data["websiteLogoLocal"] ?? "",
      websiteLogoServer: data["websiteLogoServer"] ?? "",
      adminPanelMainColor: (data["adminPanelMainColor"] != null)
          ? toColor(data["adminPanelMainColor"])
          : Color(0xff69c4ff),
  ...
  factory AppSettingsLocal.createEmpty() {
    return AppSettingsLocal(statuses: statusesDataInit);
  }

  String getStatusName(String id, String locale) {
    for (var item in statuses)
      if (item.id == id) return getTextByLocale(item.name, locale);
    return "???";
  }
}
...
class StatusData {
  ...
  StatusData(
      ...
      required this.name,
      this.position = 0,
      this.byCustomerApp = false,
      this.byProviderApp = false,
      this.localFile = "",
      this.serverPath = "",
      this.cancel = false,
      this.assetName = ""});
  ...
  factory StatusData.fromJson(Map<String, dynamic> data) {
    ...
    return StatusData(
      ...
      name: _name,
      position:
          (data["position"] != null) ? toInt(data["position"].toString()) : 0,
      byCustomerApp:
          (data["byCustomerApp"] != null) ? data["byCustomerApp"] : false,
      byProviderApp:
          (data["byProviderApp"] != null) ? data["byProviderApp"] : false,
...
List<StatusData> statusesDataInit = [
  StatusData(
      id: "1",
      name: [StringData(code: "en", text: "New request")],
      position: 1,
      byCustomerApp: true,
      byProviderApp: false,
      assetName: "assets/ondemands/ondemand8.png"),
  StatusData(
      id: "2",
      name: [StringData(code: "en", text: "Accept")],
      position: 2,
      byCustomerApp: false,
      byProviderApp: true,
      assetName: "assets/ondemands/ondemand9.png"),
  StatusData(
      id: "3",
      name: [StringData(code: "en", text: "Ready")],
      position: 3,
      byCustomerApp: false,
      byProviderApp: true,
      assetName: "assets/ondemands/ondemand10.png"),
  StatusData(
      id: "5",
      name: [StringData(code: "en", text: "Finish")],
      position: 4,
      byCustomerApp: true,
      byProviderApp: false,
      assetName: "assets/ondemands/ondemand11.png"),
  StatusData(
      id: "4",
      name: [StringData(code: "en", text: "Cancel")],
      position: 5,
      byCustomerApp: true,
      byProviderApp: true,
      cancel: true,
      assetName: "assets/ondemands/ondemand15.png"),
];

Future<String?> getSettingsFromFile(
    Function(AppSettingsLocal appSettings) onSuccess) async {
  ...
  try {
    ...
    //await _file.writeAsString(json.encode(parent.localAppSettingsLocal.toJson()));
    final contents = await _file.readAsString();
    var data = json.decode(contents);
    // dprint("_getSettings $data");
    //parent.localAppSettingsLocal = AppSettingsLocal.fromJson(data);
    var t = AppSettingsLocal.fromJson(data, "");
...
Future<String?> saveSettingsToLocalFile(AppSettingsLocal appSettings) async {
  if (kIsWeb) return null;
  var directory = await getApplicationDocumentsDirectory();
  var directoryPath = directory.path;
  var _file = File('$directoryPath/settings.json');
...
String dreamCustomSymbol = "₹";
Future<String?> settingsSaveCurrency(
    String _code, String dreamCustomSymbol) async {
  // AppSettingsLocal.code = _code;
  // AppSettingsLocal.symbol = _symbol;
  var _data = {
    "code": _code,
    "symbol": "₹",
...
Future<String?> saveSettingsShare(
    String _googlePlayLink, String _appStoreLink) async {
...
Future<String?> saveAdminPanelDarkMode(bool darkMode) async {
  // theme.darkMode
  try {
    var _data = {
