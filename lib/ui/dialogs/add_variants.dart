                    ...
                    child: Stack(
                      children: [
                          ...
                          children: [
                                ...
                                Expanded(
                                    child: Container(
                                        ...
                                        child: Combo(
                                          ...
                                          value:
                                              _mainModel.langEditDataComboValue,
                            ...
                            Row(
                              children: [
                                Expanded(
                                    child: textElement2(
                                        strings.get(54), "", _controllerName,
                                        (String val) {
                                  /// "Name",
                                })),
                                SizedBox(
                                ...
                                button2small(
                                    ...
                                    /// "Add addon",  "Save addon",
                                    () async {
                                  var ret = await productAddAddon(
                                    _controllerName.text,
                                    toDouble(_controllerPrice.text),
                                    _mainModel.langEditDataComboValue,
                                    null,
                                    strings.get(91),
                        ...
                        Container(
                          ...
                          child: button2small(strings.get(184), () {
                            /// "Close",
                            widget.close();
                          }),
                        )
    ...
    if (_providerAddons != null)
      for (var item in _providerAddons) {
        ...
        for (var currentAddon in currentProduct.addon)
          if (currentAddon.id == item.id) _found = true;
        if (!_found) {
          item.selected = false;
          _oneItem(list, _grey, item);
          _grey = !_grey;
    ...
    list.add(Row(
      children: [
        ...
        Expanded(
          ...
          color: _grey ? Colors.grey.withAlpha(80) : Colors.transparent,
          child: button134(strings.get(68),
            ...
            _controllerName.text =
                getTextByLocale(item.name, _mainModel.langEditDataComboValue);
            _redraw();
        ...
        Expanded(
          ...
          color: _grey ? Colors.grey.withAlpha(80) : Colors.transparent,
          padding: EdgeInsets.all(5),
          child: button134(strings.get(62),
        ...
        Expanded(
            child: Container(
                ...
                padding: EdgeInsets.all(5),
                child: Center(
                    child: checkBox1a(context, "", theme.mainColor,
                        theme.style14W400, item.selected, (val) {
                  if (val == null) return;
              ...
              children: [
                ...
                Flexible(
                  ...
                  if (ret != null)
                    ...
                    messageOk(context, strings.get(64));
