...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _getList() {
    ...
    list.add(SelectableText(strings.get(153), style: theme.style20W800White));
    ...
    list.add(Container(height: windowHeight * 0.8, child: EarningScreen()));
      ...
      child: SfCartesianChart(
          primaryXAxis: CategoryAxis(
            ...
            majorGridLines: MajorGridLines(
                width: 0, color: Colors.red, dashArray: <double>[5, 5]),
          ),
          ...
          // Chart title
          title: ChartTitle(
              text: strings.get(154),

              /// 'Earning',
              textStyle: theme.style16W800White),
          // Enable legend
          legend: Legend(isVisible: true, textStyle: theme.style16W800White),
          // Enable tooltip
  ...
  _providers() {
    return Expanded(
        child: Button186(
      text1: strings.get(96).toUpperCase(),
  ...
  _customers() {
    return Expanded(
        child: Button186(
      text1: strings.get(157).toUpperCase(),
  ...
  _category() {
    return Expanded(
        child: Button186(
      text1: strings.get(158).toUpperCase(),
  ...
  _service() {
    return Expanded(
        child: Button186(
      text1: strings.get(159).toUpperCase(),
