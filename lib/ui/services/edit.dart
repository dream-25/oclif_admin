...
class _EditInServicesState extends State<EditInServices> {
  ...
  Widget build(BuildContext context) {
    ...
    //
    Widget visibleWidget = checkBox1a(
        context,
        strings.get(70),
    ...
    Widget taxWidget = numberElement2Percentage(
        strings.get(130), "", _controllerTax, (String val) {
      /// "Tax",
      currentProduct.tax = toDouble(val);
      redrawMainWindow();
    });
    Widget taxAdminWidget = numberElement2Percentage(
                            ...
                            Container(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () async {
                                  if (appSettings.demo)
                                    return messageError(
                                        context, strings.get(65));

                                  /// "This is Demo Mode. You can't modify this section",
    ...
    list.add(button2b(strings.get(129), () {
    ...
    list.add(Row(
      children: [
        ...
        numberElement2("", "10", strings.get(346), _controllerDuration,
            (String val) {
          /// "min",
    ...
    list.add(Column(
      children: [
        ...
        TreeInCategory(
          showDelete: false,
          showCheckBoxes: true,
          stringOnlySelected: strings.get(168),
      ...
      children: [
        ...
        Combo(
          ...
          onChange: (String value) {
            ...
            if (value != "1") currentProduct.providers.add(value);
    ...
    if (currentProduct.id.isEmpty)
      list.add(button2b(strings.get(146), () async {
        /// "Create new service",
        var ret = _checkData();
      ...
      list.add(Row(
        children: [
          Expanded(
              child: button2b(strings.get(147), () async {
          ...
          button2b(strings.get(148), _mainModel.service.emptyCurrent)
    ...
    return Stack(
      children: [
        Container(
            width: _mainModel
                .getEditWorkspaceWidthWithEmulator(), //(windowWidth/2 < 600) ? 600 : windowWidth/2,
  ...
  String? _checkData() {
    if (getMinAmountInProduct(currentProduct.price) <= 0)
      return strings.get(472);

    /// "Price can't be 0",
    if (currentProduct.name.isEmpty) return strings.get(91);

    /// "Please Enter Name",
    if (currentProduct.price.isEmpty) return strings.get(342);

    /// "Please enter price",
    if (currentProduct.providers.isEmpty) return strings.get(221);

    /// Please select provider
    if (currentProduct.category.isEmpty) return strings.get(343);
          ...
          child: Column(
            children: [
              numberElement2Price(
                  ...
                  "123",
                  "₹",
                  _controllerPrice[level], (String val) {
              ...
              numberElement2Price(
                  ...
                  "123",
                  "₹",
                  _controllerDiscPrice[level], (String val) {
              ...
              Row(
                children: [
                  Expanded(
                      child: Combo(
                    inRow: true, text: strings.get(151),
              ...
              textElement2(strings.get(54), "", _controllerNamePrice[level],
                  (String val) {
                /// "Name",
                productSetNamePrice(
                    val, level, _mainModel.langEditDataComboValue);
                if (_currentPriceLevel == level) _currentPriceLevel++;
                redrawMainWindow();
              }),
              SizedBox(
              ...
              button2small(strings.get(75), () {
                _selectImageForPrice(level);
              }),
              ...
              button2b(strings.get(75), () {
                _selectImageForPrice(level);
              }),

              /// "Select image",
              if (level < currentProduct.price.length)
                button2c(strings.get(62), Colors.red, () {
                  /// "Delete",
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                    child: textElement2(
                        strings.get(54), "", _controllerNamePrice[level],
                        (String val) {
                  /// "Name",
                  productSetNamePrice(
                      val, level, _mainModel.langEditDataComboValue);
  ...
  _selectImageForPrice(int level) async {
    ...
    if (pickedFile != null) {
      _waits(true);
      var ret =
          await productSetPriceImageData(await pickedFile.readAsBytes(), level);
      if (ret != null) messageError(context, ret);
      _waits(false);
      redrawMainWindow();
    }
  ...
  _init() {
    ...
    _controllerDescTitle.text =
        _mainModel.getTextByLocale(currentProduct.descTitle);
    ...
    _mainModel.provider.providersComboValueForService =
        currentProduct.providers.isNotEmpty ? currentProduct.providers[0] : "1";
  }
  ...
  _listAddons() {
    ...
    return Wrap(runSpacing: 10, spacing: 10, children: list);
  }
}
