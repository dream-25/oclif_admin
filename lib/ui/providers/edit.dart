...
class _EditInProviderState extends State<EditInProvider> {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) async {
      if (_mainModel.provider.newProvider != null) {
        ...
        _controllerName.text =
            getTextByLocale(currentProvider.name, strings.locale);
        _controllerAddress.text = currentProvider.address;
        _controllerDesc.text =
            getTextByLocale(currentProvider.desc, strings.locale);
  ...
  Widget build(BuildContext context) {
    ...
    if (_mainModel.provider.newProvider != null) {
      ...
      /// For assign new provider set needed fields...
      list.add(SizedBox(
        height: 10,
      ));
    }
    ...
    if (isMobile()) {
      ...
      list.add(
          textElement2(strings.get(248), "", _controllerEmail, (String val) {
        /// "Login Email",
      ...
      list.add(Row(
        children: [
          Expanded(
              child: textElement2(strings.get(54), "", _controllerName,
                  (String val) {
            /// "Name",
            providerSetName(val, _mainModel.langEditDataComboValue);
            redrawMainWindow();
          ...
          Expanded(
              child: textElement2(strings.get(248), "", _controllerEmail,
                  (String val) {
            /// "Login Email",
            currentProvider.login = val;
            redrawMainWindow();
    ...
    if (!appSettings.enableSubscriptions)
      list.add(numberElement2Percentage(strings.get(265), "", _controllerTax,
          (String val) {
        /// "Default Tax for provider (administration payment)",
    ...
    list.add(
        textElement2(strings.get(120), "", _controllerDescTitle, (String val) {
      /// Description Title
    ...
    // description
    //
    list.add(textElement2(strings.get(73), "", _controllerDesc, (String val) {
      /// Description
    ...
    //
    list.add(
        textElement2(strings.get(97), "", _controllerAddress, (String val) {
      /// Address
    ...
    list.add(Row(
      children: [
        ...
        button2b(strings.get(75), _selectUpperImage),
    ...
    list.add(SelectableText(
      currentProvider.imageUpperServerPath,
      style: theme.style14W400,
    ));
    list.add(SizedBox(
      height: 5,
    ...
    list.add(Row(
      children: [
        ...
        button2b(strings.get(75), _selectLogoImage),
    ...
    list.add(SelectableText(
      currentProvider.logoServerPath,
      style: theme.style14W400,
    ));
    list.add(SizedBox(
      height: 5,
    ...
    list.add(TreeInCategory(
      ...
      stringCategoryTree: strings.get(232),
    ...
    list.add(Row(
      children: [
        Expanded(
            child: textElement2(strings.get(124), "", _controllerPhone,
                (String val) {
          /// "Phone",
        ...
        Expanded(
            child: textElement2(strings.get(125), "", _controllerWww,
                (String val) {
          /// "Web Page",
    ...
    list.add(Row(
      children: [
        Expanded(
            child: textElement2(strings.get(126), "", _controllerTelegram,
                (String val) {
          /// "Telegram",
        ...
        Expanded(
            child: textElement2(strings.get(127), "", _controllerInstagram,
                (String val) {
          /// "Instagram",
    ...
    // Gallery
    //
    list.add(Text(strings.get(128), style: theme.style16W800));
                            ...
                            Container(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (ret == null)
                                    messageOk(context, strings.get(219));
    ...
    list.add(button2b(strings.get(129), _selectImageToGallery));
    ...
    list.add(Row(
      children: [
        CheckBox12(
          () {
            return currentProvider.useMaximumServices;
          },
          (bool value) {
        ...
        /// Maximum services count for this provider
        SizedBox(
          width: 10,
        ),
        if (currentProvider.useMaximumServices)
          Container(
              width: 150,
              child: Edit41Number(
                controller: _controllerMaxServices,
                ...
                backgroundColor: (aTheme.darkMode)
                    ? aTheme.blackColorTitleBkg
                    : Colors.white,
                hint: "123",
                color: Colors.grey,
              )),
    ...
    list.add(Row(
      children: [
        CheckBox12(() {
          return currentProvider.useMaxAddonInOneService;
        }, (bool value) {
        ...
        /// Maximum addons count for each service
        SizedBox(
          width: 10,
        ),
        if (currentProvider.useMaxAddonInOneService)
          Container(
              width: 150,
              child: Edit41Number(
                controller: _controllerMaxAddonInOneService,
                radius: aTheme.radius,
                style: aTheme.style14W400,
                onChange: (String val) {
    ...
    list.add(Row(
      children: [
        CheckBox12(() {
          return currentProvider.useMaximumProducts;
        }, (bool value) {
        ...
        /// "Maximum products count for this provider",
        SizedBox(
          width: 10,
        ),
        if (currentProvider.useMaximumProducts)
          Container(
              width: 150,
              child: Edit41Number(
                controller: _controllerMaxProducts,
                radius: aTheme.radius,
                style: aTheme.style14W400,
                onChange: (String val) {
    ...
    list.add(Row(
      children: [
        CheckBox12(() {
          return currentProvider.useMinPurchaseAmount;
        }, (bool value) {
        ...
        if (currentProvider.useMinPurchaseAmount)
          Container(
            width: 150,
            child: Edit41web(
              controller: _controllerMinPurchaseAmount,
              price: true,
    ...
    list.add(Row(
      children: [
        CheckBox12(() {
          return currentProvider.useMaxPurchaseAmount;
        }, (bool value) {
        ...
        if (currentProvider.useMaxPurchaseAmount)
          Container(
            width: 150,
            child: Edit41web(
              controller: _controllerMaxPurchaseAmount,
              price: true,
              numberOfDigits: appSettings.digitsAfterComma,
              onChange: (String val) {
    ...
    list.add(Row(
      children: [
        CheckBox12(() {
          return currentProvider.acceptPaymentInCash;
        }, (bool value) {
        ...
        /// "Enable payment in cache for this provider",
      ],
    ));
    list.add(SizedBox(
      height: 10,
    ...
    list.add(Row(
      children: [
        ...
        /// "Allow booking only if customer located in provider work area",
      ],
    ));
    ...
    if (currentProvider.id.isEmpty)
      list.add(button2b(strings.get(121), () async {
        /// "Create new provider",
        var ret = _checkData();
        if (ret != null) return messageError(context, ret);
        ret = await createProviderFromAdmin(_mainModel.provider.newProvider,
            _mainModel.provider.providersRequest);
        if (ret == null)
          messageOk(context, strings.get(81));
      ...
      list.add(Row(
        children: [
          Expanded(
              child: button2b(strings.get(122), () async {
  ...
  String? _checkData() {
    if (currentProvider.name.isEmpty) return strings.get(91);

    /// "Please Enter Name",
    if (currentProvider.login.isEmpty) return strings.get(480);

    /// "Please Enter Login Email",
    if (currentProvider.address.isEmpty) return strings.get(481);

    /// "Please Enter Address",
    if (currentProvider.route.isEmpty) return strings.get(482);

    /// "Please Enter Work Area",
    if (currentProvider.logoServerPath.isEmpty) return strings.get(483);

    /// "Please upload Logo image",
    if (currentProvider.useMinPurchaseAmount &&
        currentProvider.minPurchaseAmount <= 0) return strings.get(487);

    /// "Please enter minimum order amount",
    if (currentProvider.useMaxPurchaseAmount &&
        currentProvider.maxPurchaseAmount <= 0) return strings.get(488);

    /// "Please enter maximum order amount",
    if (currentProvider.useMinPurchaseAmount &&
        currentProvider.useMaxPurchaseAmount) {
      if (currentProvider.minPurchaseAmount > currentProvider.maxPurchaseAmount)
        return strings.get(484);

      /// "Minimum purchase amount must be smaller then maximum purchase amount ",
      if (currentProvider.minPurchaseAmount ==
          currentProvider.maxPurchaseAmount) return strings.get(485);

      /// "Minimum and maximum purchase amount must be different",
    }
    if (currentProvider.category.isEmpty) return strings.get(486);
      ...
      children: [
        ...
        Expanded(
            child: checkBox1a(
                ...
                theme.mainColor,
                theme.style14W400,
                getWeekend(_mainModel.provider.weekDataComboValue), (val) {
          if (val == null) return;
    ...
    return Row(children: [
      InkWell(
          onTap: () async {
            await selectOpenDate(
                context, _mainModel.provider.weekDataComboValue);
            redrawMainWindow();
          },
          child: Container(
              width: 100,
              ...
              child: Center(
                  child: Text(
                getOpenTime(_mainModel.provider.weekDataComboValue),
      ...
      InkWell(
          ...
          child: Container(
              ...
              child: Center(
                  child: Text(
                getCloseTime(_mainModel.provider.weekDataComboValue),
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800),
              ))))
    ]);
  }
  ...
  _selectImageToGallery() async {
    ...
    if (pickedFile != null) {
      ...
      if (ret != null)
        ...
        messageOk(context, strings.get(363));
  ...
  _init() {
    ...
    _controllerDescTitle.text =
        _mainModel.getTextByLocale(currentProvider.descTitle);
    ...
    _controllerMaxAddonInOneService.text =
        currentProvider.maxAddonInOneService.toString();
    _controllerMaxProducts.text = currentProvider.maxProducts.toString();
    _controllerMinPurchaseAmount.text =
        currentProvider.minPurchaseAmount.toString();
    _controllerMaxPurchaseAmount.text =
        currentProvider.maxPurchaseAmount.toString();
  }
}
