...
class _BookNow3ScreenState extends State<BookNow3Screen> {
  ...
  _book() {
    ...
    //         Provider.of<MainModel>(context,listen:false).localAppSettingsLocal.code,
    ...
    //           currency: Provider.of<MainModel>(context,listen:false).localAppSettingsLocal.code,
    //           userFirstName: "",
    //           userLastName: "",
    //           userEmail: "",
    //           payAmount: _total,
  ...
  _body() {
    ...
    list.add(Container(
      ...
      child: Row(
        children: [
          Expanded(
              child: Text(strings.get(77), // "Total",
    ...
    list.add(Container(
      ...
      child: checkBox43(
          strings.get(81), // "Cash payment",
          serviceApp.booking4CheckBoxColor,
          "assets/cache.png",
          theme.style14W800,
          true, (val) {
        // if (val) {
    ...
    list.add(Container(
      ...
      child: checkBox43("Stripe", serviceApp.booking4CheckBoxColor,
          "assets/stripe.png", theme.style14W800, false, (val) {
        // if (val) {
    ...
    list.add(Container(
        ...
        child: checkBox43("Razorpay", serviceApp.booking4CheckBoxColor,
            "assets/razorpay.png", theme.style14W800, false, (val) {
          // if (val) {
    ...
    list.add(Container(
        ...
        child: checkBox43("Pay Pal", serviceApp.booking4CheckBoxColor,
            "assets/paypal.png", theme.style14W800, false, (val) {
          // if (val) {
